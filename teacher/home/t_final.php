<table id="tblData" class="table table-bordered table-sm">
    <thead class="text-center">
        ...
        <tr style="background-color: yellow;">
            <?php  for($i = 1; $i <= 5; $i++){
            echo "<th width='1%'>".$rowtl3['pt'.$i]."</th>";
            }?>

            <th width="1%" ><?php echo $final_tltotal;?></th>

            <?php  for($i = 1; $i <= 5; $i++){
            echo "<th width='1%'>".$rowtl3['quiz'.$i]."</th>";
            }?>

            <th width="1%"><?php echo $final_tl_quiztotal;?></th>
            <th width="1%"><?php echo $rowtl3['exam']; ?></th>
            <th width="1%"><?php echo $rowtl3['exam']; ?></th>
            <th><?php echo $final_tltotal;?></th>
            <th width="1%"><?php echo $final_tl_quiztotal;?></th>
            <th width="1%"><?php echo $rowtl3['exam'];?></th>
            <th width="1%"><?php echo $final_tltotal + $final_tl_quiztotal + $rowtl3['exam'];?></th>
        </tr>
    </thead>
        <?php
        $grades=mysqli_query($conn,"SELECT * FROM student_final WHERE subid='$subjectid' AND sy='$subjectsy'");
    ...
    <tbody class="text-center">
        ...
        <td id="g_green"><?php $finaltotal = $pttotal + $quiztotal + $totalexam; echo round($finaltotal);?></td>
    </tbody>
    <?php
    }
    ?>

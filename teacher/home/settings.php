                        ...
                        <div class="card-body p-1">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card">
                                            <div class="card-header" id="card-header">
                                                <h3 class="card-title text-center" data-card-widget="collapse"><b>Change Profile Name</b></h3>
                                            </div>
                                            <form method="post">
                                                <div class="card-body">
                                                    <div class="form-group my-3">
                                                    <label class="form-label">First Name</label>
                                                    <input type="text" name="fname" id="fname" class="form-control mt-2" value="<?php echo $row1['fname']?>"required>
                                                    </div>
                                                    <div class="form-group my-3">
                                                    <label class="form-label">Middle Initials</label>
                                                    <input type="text" name="mname" id="mname" class="form-control mt-2" value="<?php echo $row1['mname']?>"required>
                                                    </div>
                                                    <div class="form-group my-3">
                                                    <label class="form-label">Last Name</label>
                                                    <input type="text" name="lname" id="lname" class="form-control mt-2" value="<?php echo $row1['lname']?>" required>
                                                    </div>
                                                    <button type="submit" class="update_techinfo btn btn-dark btn-sm elevation-3" id="button-all"><i class="fas fa-save"></i> Update</button>
                                                </div>
                                            </form> 
                                        </div> 
                                    </div> 
                                        ...
                                        <div class="card">
                                            ...
                                            <form method="post">
                                                <div class="card-body">
                                                    ...
                                                    <input type="password" name="currentPassword" id="currentPassword" class="form-control mt-2" required>
                                                    </div>
                                                    <div class="form-group my-3">
                                                    <label class="form-label">New Password</label>
                                                    <input type="password" name="newPassword" id="newPassword" class="form-control mt-2" required>
                                                    </div>
                                                    <div class="form-group my-3">
                                                    <label class="form-label">Confirm Password</label>
                                                    <input type="password" name="confirmPassword" id="confirmPassword" class="form-control mt-2" required>
                                                    </div>
                                                    <div class="form-group my-3">
...
$(document).ready(function(){
  ...
  $('.crop_image').click(function(event){
    ...
    $(document).on('click','.update_techinfo', function(){
        ...
        url:"action.php",
        method:"POST",
        data:{action:action,fname:fname,mname:mname,lname:lname},
        success:function(data)
        {
        }
        });

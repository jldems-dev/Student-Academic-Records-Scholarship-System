<?php
    ...
    $teachertoggle=mysqli_query($conn,"SELECT * FROM teachertoggole WHERE teachid='$newid' AND term='Prelim' AND subid='$subjectid'");
    $rowttoggle=mysqli_fetch_assoc($teachertoggle);

    $teachertoggle1=mysqli_query($conn,"SELECT * FROM teachertoggole WHERE teachid='$newid' AND term='Midterm' AND subid='$subjectid'");
    $rowttoggle1=mysqli_fetch_assoc($teachertoggle1);

    $teachertoggle2=mysqli_query($conn,"SELECT * FROM teachertoggole WHERE teachid='$newid' AND term='Prefinal' AND subid='$subjectid'");
    $rowttoggle2=mysqli_fetch_assoc($teachertoggle2);

    $teachertoggle3=mysqli_query($conn,"SELECT * FROM teachertoggole WHERE teachid='$newid' AND term='Final' AND subid='$subjectid'");
    $rowttoggle3=mysqli_fetch_assoc($teachertoggle3);

    /* --------------------------------------------------------------------------------------------------------------------------------- */

  /*   $term_array= array("Prelim", "Midterm", "Prefinal", "Final");

    for($i = $term_array; $i <= length($term_array); $i++){

    } */
    $teacherlabel=mysqli_query($conn,"SELECT * FROM teacher_label WHERE teachid='$newid' AND term='Prelim' AND subid='$subjectid'");
    ...
    $teacherlabel1=mysqli_query($conn,"SELECT * FROM teacher_label WHERE teachid='$newid' AND term='Midterm' AND subid='$subjectid'");
    ...
    $teacherlabel2=mysqli_query($conn,"SELECT * FROM teacher_label WHERE teachid='$newid' AND term='Prefinal' AND subid='$subjectid'");
    ...
    $teacherlabel3=mysqli_query($conn,"SELECT * FROM teacher_label WHERE teachid='$newid' AND term='Final' AND subid='$subjectid'");
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-indent"></i> Student Grade Sheets Tabs</h3>
                        </div>

...
<body class="hold-transition layout-top-nav" >
  <div class="wrapper">
    ...
    <div class="content-wrapper login-page" id="sch-background">
      <div class="content">
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <div class="login-box">
                <div class="circle d-flex justify-content-center pb-4">
                  <img src="../img/scholarshipicon.png" alt="Avatar"class="center">
                </div>
                <div class="card" id="admin-card">
                  <div class="card-header text-center" id="text-wshadow">
                    <a href="" class="h3" id="admin-login-font"><b>Scholarship Office Login</b></a>
                  </div>
                  <div class="card-body">

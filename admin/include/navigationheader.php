...
<div class="wrapper">
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" >
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown ">
        ...
        <img src="<?php echo $row['ava_location'];?>" alt="Empty" class="brand-image img-circle elevation-3" style="width: 30px;"> 
  ...
  <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-3 pb-5" id="card-header">
    <a href="../admin/index.php" class="brand-link">
      <img src="../img/sageRm-app.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">

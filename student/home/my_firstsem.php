      ...
      <div class ="card" id="index-color">
        <div class="card-header">
          <div class="d-flex align-items-center">
            ...
            <h3 class="card-title w-100" id="arrow-back"><img src="img/1sem.png" width="24px" height="24px" id="icon-img-shadow"> First Semester</h3>
          </div>
        </div>
      </div>
      <div class="card" >
        <div class="card-header" id="card-header1">
          <div class="d-flex align-items-center">
            <h3 class="card-title">School Year: <?php echo $yearall;?></h3>
          </div>
        </div>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-sm" id="table-fsemester">
                  <thead>
                    ...
                    <?php
                        $record = mysqli_query($conn,"SELECT * FROM student_record WHERE studid='$dbid' AND sem='1st'");
